...
You are configuring the Autonomous Storefront recipe for my ApparelHub account. This is a
...
2. Call `list_my_workspaces`. If I have more than one, ask me which workspace this store should
...
3. Call `list_my_stores(workspace=<that uuid>)`. Show me the stores with their fulfillment
   ...
   - the **primary store** (the one this brand runs on),
